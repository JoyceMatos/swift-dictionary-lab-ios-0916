 ...
 */
var anotherCapital = stateCapitals["Harrisburg"]
...
var theBeatlesMembers = ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"]
var theBreedersMembers = ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"]
var pixiesMembers = ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]
...
if let bandName = bands[bandName] {
    print("\(bandName)")
}
